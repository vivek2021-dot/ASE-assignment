## A simulation of the famous "infinite two-dimensional orthogonal grid of square cell" using Javascript

#### Better viewed in Desktop site and Mobile device

## infinite, two-dimensional orthogonal grid of square cells, each of which is in one of two possible states, live or
dead, (or populated and unpopulated, respectively). Every cell interacts with its
